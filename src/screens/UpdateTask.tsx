...
export default function UpdateTaskScreen({ navigation, route }: AddTaskProps): React.JSX.Element {
  ...
  const handleUpdateTask = async (values) => {
    try {
      ...
      dispatch(updateTask({ ...values, deadline: deadlineString, _id: task._id }));
      Toast.show({
        text1: 'Task Updated',
        text2: 'Your task has been successfully updated!',
        type: 'success',
        position: 'top',
        visibilityTime: 3000,
        autoHide: true,
